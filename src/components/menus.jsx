...
class Menus extends Component {
 ...
 render() {
  ...
  return(
      ...
      <Carousel fade style={{ zIndex: 0 }}>
        ...
        <Carousel.Item >
          <div className="carouselImage">
            ...
            <p className="secondMainTitle" style={{ fontFamily: 'Lato , sans-serif'}}>WE LOVE <br />WHAT WE DO</p>
            <h2 className="secondSubTitle" style={{ fontFamily: 'Barlow Condensed, sans-serif' }}>A cup of coffee lasts only a moment, but it is <br /> that moment that makes your day better.</h2>
          </div>
        </Carousel.Item>
        <Carousel.Item >
          <div className="carouselImage">
          <img src={Image} width="100%" alt="coffee"/>
            <h1 className="thirdMainTitle" style={{  fontFamily: 'Lato , sans-serif', marginBottom: "20px" }}>COFFEE IS <br />OUR LANGUAGE</h1>
            <h2 className="thirdSubTitle" style={{  fontFamily: 'Barlow Condensed, sans-serif' }}>A cup of coffee lasts only a moment, but it is <br /> that moment that makes your day better.</h2>
          </div>
        </Carousel.Item>
   ...
   <div style={{ backgroundColor: "black", margin: "80px 10px 80px 10px"}}>
    ...
    <section className="imgSections">
      <div className="container">
        <div className="row">
          <div className="col-lg-6" style={{ color: "white", textAlign: "center", margin: "auto" }}>
              <div style={{ width: "80%", margin: "auto", textAlign: "left", padding: "50px" }}>
              <h1 style={{ color: "white", fontFamily: 'Oswald, sans-serif', fontWeight: "700", lineHeight: "1.14286em", marginBottom: "2px", textAlign: "left" }}>Coffee Shop</h1>
              ...
              <button className="btn p-2" style={{ backgroundColor: "#c7a17a", color: "white" }}>READ MORE</button>
              </div>
          </div>
          <div className="col-lg-6">
            <img className="m-5" width="80%" src="https://barista.qodeinteractive.com/elementor/wp-content/uploads/2017/01/home-1-blog-f-img-2.jpg" alt="coffee"/>
          </div>
        </div>
      </div>
    </section>
    <div style={{ backgroundColor: "black", margin: "80px"}}>
    <p style={{ color: "#c7a17a", fontSize: '18px', fontFamily: 'Merriweather, serif', textAlign: "center"}}>Choose one of our flavours</p>
    <h1 style={{ color: "white", fontFamily: 'Oswald, sans-serif', fontWeight: "700", lineHeight: "1.14286em", marginBottom: "19px", textAlign: "center" }}>COFFEE BUILD YOUR BASE.</h1>
    <div className="lineCard">
    <div style={{ width: "120px", borderBottomWidth: "3px", borderBottom: "3px solid #c7a17a", verticalAlign:"middle", position: "relative", display:"inline-block", margin:"5px 0", lineHeight: "1em"}}></div>
    </div>
    <div>
      <div className="container" style={{ textAlign: "center" }}>
        <div className="row">
          ...
          <div className="col-lg-3">
          <div className="cards">
            <img src="https://barista.qodeinteractive.com/elementor/wp-content/uploads/2017/01/home-3-icon-image-2.png" alt="coffee"/>
          <Card className={classes.root}  style={{ border: "none", boxShadow: "none", borderRadius: "0" }}>
            <CardActionArea>
              <CardContent style={{ backgroundColor: "black", color:"white", padding: "30px 0", fontFamily: "Oswald,sans-serif" }}>
                <Typography gutterBottom variant="h5" component="h3" style={{fontFamily: "Oswald,sans-serif"}}>
          ...
          <div className="col-lg-3">
          <div className="cards">
            <img src="https://barista.qodeinteractive.com/elementor/wp-content/uploads/2017/01/home-3-icon-image-3.png" height="50%" alt="coffee"/>
          <Card className={classes.root}  style={{ border: "none", boxShadow: "none", borderRadius: "0" }}>
            <CardActionArea>
              <CardContent style={{ backgroundColor: "black", color:"white", padding: "30px 0", fontFamily: "Oswald,sans-serif" }}>
                <Typography gutterBottom variant="h5" component="h3" style={{fontFamily: "Oswald,sans-serif"}}>
          ...
          <div className="col-lg-3">
          <div className="cards">
            <img src="https://barista.qodeinteractive.com/elementor/wp-content/uploads/2017/01/home-3-icon-image-4.png" alt="coffee"/>
          <Card className={classes.root} style={{ border: "none", boxShadow: "none", borderRadius: "0" }}>
            <CardActionArea>
              <CardContent style={{ backgroundColor: "black", color:"white", padding: "30px 0", fontFamily: "Oswald,sans-serif" }}>
                <Typography gutterBottom variant="h5" component="h3" style={{fontFamily: "Oswald,sans-serif"}}>
