...
const stripePromise = loadStripe(
  "pk_test_51JAuGpSH4mPX8koHXg1rhzwl4HnX8K9EqzbqwouOQr8K9sd6zb5f0bUVZGn9Fuzyhoi7zMQ0IGZyzR4ZnH4m0pMD00eMvU15wo"
);
...
class cart extends Component {
  ...
  render() {
    const total =
      this.props.menus.length !== 0 ? this.getArraySum(this.props.menus) : 0;
    let status = false;
          ...
          return (
            <div>
              <button
                ...
                style={{ marginRight: "10px", fontSize: "12px", marginTop: 0 }}
                onClick={() => this.decreaseItems(params.row)}
              >
                -
              </button>
              {params.value}
              <button
                className="btn btn-outline-success"
                style={{ marginLeft: "10px", fontSize: "12px", marginTop: 0 }}
                onClick={() => this.increaseItems(params.row)}
              >
                +
              </button>
            </div>
    ...
    return (
      <div>
        <div className="container mt-3">
          ...
          >
            <h1 style={{ textAlign: "left", margin: "30px" }}>
              Your Bag{" "}
              <span className="h5">{this.props.menus.length} item</span>
            </h1>
            <div
              className="col"
              style={{ height: 450, width: "100%", textAlign: "center" }}
            >
              <DataGrid
                rows={rows}
                columns={columns}
            ...
            <h4 style={{ padding: "30px", textAlign: "right" }}>
              Total: ${total}
            </h4>
          </div>
          <div style={{ textAlign: "center", padding: "20px" }}>
            <Button
              onClick={() => this.submitCart(this.props.menus, total)}
              variant="outlined"
            ...
            >
              <Link to="/menu" style={{ textDecoration: "none", color: "red" }}>
                {" "}
                Go Back{" "}
              </Link>
            </Button>
        ...
        <Modal
          isOpen={this.state.ModalVisibles}
          ...
          <ModalBody style={{ padding: "0px" }}>
            ...
            >
              ...
              >
                <div>
                  <div
                    className="container mt-3 shadow p-2"
                    style={{ backgroundColor: "white", borderRadius: "10px" }}
                  >
                    <h4 className="fw-normal p-3">
                      Cart Details
                      <span className="h5 pull-right"> Total:${total} </span>
                    </h4>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="col-lg-6 p-3">
                            <h4 style={{ margin: "auto", textAlign: "left" }}>
                              {item.title}
                            </h4>
            ...
            <button
              className="btn btn-outline-danger btnAdd m-4"
              onClick={this.modalCloseToggles}
            >
              Close
            </button>
          </ModalBody>
