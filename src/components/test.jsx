 ...
 */
 ...
 Editor.propTypes = {
   placeholder: React.PropTypes.string,
     ...
     console.log(this.reactQuillRef.getEditor().clipboard);
     // this.quillRef = this.reactQuillRef.getEditor();
     // this.quillRef.root.innerHTML = html
     const delta = this.reactQuillRef.getEditor().clipboard.convert(html)
     console.log(delta);
     delta.ops[0].attributes={id:"key"}
     this.reactQuillRef.getEditor().setContents(delta, 'silent')
     console.log(this.reactQuillRef.getEditor().root.innerHTML);
     this.reactQuillRef.getEditor().root.innerHTML.document.querySelector("div").classList.add("container")
     console.log(this.reactQuillRef.getEditor().root.innerHTML);
