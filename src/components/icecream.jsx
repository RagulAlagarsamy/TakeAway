...
class icecream extends Component {
    ...
    render() {
        return (
            ...
            <img src="https://cdn.shortpixel.ai/client/q_lossless,ret_img,w_1440/https://www.havmor.com/wp-content/uploads/2020/04/Party-Packs-1.png" width="100%"></img>
            ...
            <div className="mainContents text-center"  style={{ backgroundColor:"white" }}>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <img src="https://www.vadilalicecreams.com/wp-content/uploads/2018/05/golden-fantasey.png" width="80%" ></img>
                        <h4 style={{ color:"#8e2e03", paddingTop: "25px" }}>French Icecreams</h4>
                        </div>
                        <div className="col-lg-4">
                        <img src="https://thumbs.dreamstime.com/b/bowl-ice-cream-balls-isolated-white-background-176524142.jpg" width="100%" ></img>
                        <h4 style={{ color:"#8e2e03", paddingTop: "0px"}}>Hard Icecreams</h4>
                        </div>
                        <div className="col-lg-4">
                        <img src="https://cdn.picpng.com/ice_cream/ice-cream-hd-27205.png" width="80%" ></img>
            ...
            <div className="container-fluid mt-4">
                    <div className="row">
                        ...
                        <img src="https://img.etimg.com/thumb/width-1200,height-900,imgsize-53188,resizemode-1,msid-49335020/can-vadilal-make-india-drool-with-its-non-ice-cream-products.jpg" width="100%" ></img>
                        </div>
                ...
                <h1 style={{ color:"#8e2e03" }}>Ice Cream Cakes</h1>
                    <div className="row m-5">
                        ...
                        <img src="https://i.pinimg.com/originals/dc/fd/74/dcfd743a38bb669ded0aaf8623c8b6ec.png" width="100%" ></img>
                        <h4>Custard Icecream Cakes</h4>
                        </div>
                        <div className="col-lg-4 pt-4">
                        <img src="https://images.heb.com/is/image/HEBGrocery/000773614?fit=constrain,1&wid=800&hei=800&fmt=jpg&qlt=85,0&resMode=sharp2&op_usm=1.75,0.3,2,0" width="90%" ></img>
                        <h4>Oreo Icecream Cakes</h4>
                        </div>
                    </div>
                </div>
                    <img src="https://creamistry.com/assets_front/images/footer_image.jpg" width="100%"></img>
            </div>
        );
    }
}
